        ...
        <form method="POST">
            ...
            <div class="row">
                ...
                <div class="form-group mt-1 col-lg-3">
                    ...
                    <input type="text" name="ocupacao" class="form-control bg-dark text-white" placeholder="Ocupação">
                </div>
                <div class="form-group mt-1 col-lg-3">
                    <label>Sexo</label>
                    <input type="text" name="sexo" class="form-control bg-dark text-white" text-white placeholder="Sexo">
                </div>
